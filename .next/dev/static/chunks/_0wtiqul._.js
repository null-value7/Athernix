...
"[project]/models/AI/chatbot.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/controllers/AI/chatbot.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/AI/chatbot.ts [app-client] (ecmascript)");
...
function getText(parts) {
    return parts?.find(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isTextUIPart"])?.text ?? '';
}
...
function useAltChatController() {
    _s();
    const [sidebar, setSidebar] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialSidebar);
    ...
    const currentSessionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const scrollToBottom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[scrollToBottom]": ()=>{
            setTimeout({
                "useAltChatController.useCallback[scrollToBottom]": ()=>messagesEndRef.current?.scrollIntoView({
                        behavior: 'smooth'
                    })
            }["useAltChatController.useCallback[scrollToBottom]"], 30);
        }
    }["useAltChatController.useCallback[scrollToBottom]"], []);
    // ── Cargar historial real desde Supabase al montar ────────
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAltChatController.useEffect": ()=>{
            let cancelled = false;
            ({
                "useAltChatController.useEffect": async ()=>{
                    const sessions = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchUserSessions"])();
                    if (!cancelled) {
                        setSidebar({
                            "useAltChatController.useEffect": (s)=>({
                                    ...s,
                                    sessions
                                })
                        }["useAltChatController.useEffect"]);
    ...
    // ── useChat (AI SDK v6) ───────────────────────────────────
    const { messages, status, setMessages, sendMessage: sdkSend } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$react$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useChat"])({
        ...
        onEnd: {
            "useAltChatController.useChat": async ({ message, messages: finishedMsgs })=>{
                const userMsg = [
                    ...finishedMsgs
                ].reverse().find({
                    "useAltChatController.useChat.userMsg": (m)=>m.role === 'user'
                }["useAltChatController.useChat.userMsg"]);
                ...
                if (!sessionId) {
                    const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createChatSession"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeAltSessionTitle"])(userText || 'Nueva sesión'));
                    if (created) {
                ...
                if (sessionId) {
                    if (userText) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["insertChatMessage"])(sessionId, 'user', userText);
                    if (assistantText) await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["insertChatMessage"])(sessionId, 'assistant', assistantText);
                }
                // 3. Actualizar UI del sidebar
                const allMsgs = finishedMsgs.filter({
                    "useAltChatController.useChat.allMsgs": (m)=>m.role === 'user' || m.role === 'assistant'
                }["useAltChatController.useChat.allMsgs"]).map({
                    "useAltChatController.useChat.allMsgs": (m)=>({
                            role: m.role === 'assistant' ? 'ai' : 'user',
                            text: getText(m.parts)
                        })
                }["useAltChatController.useChat.allMsgs"]).filter({
                    "useAltChatController.useChat.allMsgs": (m)=>m.text.length > 0
                }["useAltChatController.useChat.allMsgs"]);
                setSidebar({
                    "useAltChatController.useChat": (s)=>{
                        let sessions = [
                            ...s.sessions
                        ];
                        const exists = sessionId && sessions.some({
                            "useAltChatController.useChat": (sess)=>sess.id === sessionId
                        }["useAltChatController.useChat"]);
                        if (sessionId && !exists) {
                            const newSess = {
                                id: sessionId,
                                title: (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["makeAltSessionTitle"])(userText || 'Nueva sesión'),
                                date: 'Ahora',
                                msgs: allMsgs
                            };
                            sessions = [
    ...
    const toggleSidebar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[toggleSidebar]": ()=>{
            setSidebar({
                "useAltChatController.useCallback[toggleSidebar]": (s)=>({
                        ...s,
    ...
    const newChat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[newChat]": ()=>{
            setMessages([]);
            setInput('');
            currentSessionRef.current = null;
            setSidebar({
                "useAltChatController.useCallback[newChat]": (s)=>({
                        ...s,
                        currentSession: null,
                        sidebarOpen: false
                    })
    ...
    const loadSession = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[loadSession]": async (id)=>{
            const msgs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchSessionMessages"])(id);
            setMessages(msgs.map({
                "useAltChatController.useCallback[loadSession]": (m, i)=>({
                        id: `${id}-${i}`,
            ...
            }["useAltChatController.useCallback[loadSession]"]));
            currentSessionRef.current = id;
            setSidebar({
                "useAltChatController.useCallback[loadSession]": (s)=>({
                        ...s,
                        currentSession: id,
                        sidebarOpen: false
                    })
    ...
    const sendMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[sendMessage]": (text)=>{
    ...
    }["useAltChatController.useCallback[sendMessage]"], [
        busy,
        sdkSend,
        scrollToBottom
    ]);
    ...
    const handleSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[handleSubmit]": (e)=>{
            e.preventDefault();
            sendMessage(input);
        }
    }["useAltChatController.useCallback[handleSubmit]"], [
        input,
        sendMessage
    ]);
    const handleKeyDown = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAltChatController.useCallback[handleKeyDown]": (e)=>{
            if (e.key === 'Enter' && !e.shiftKey) {
                e.preventDefault();
                sendMessage(input);
            }
        }
    }["useAltChatController.useCallback[handleKeyDown]"], [
        input,
        sendMessage
    ]);
...
_s(useAltChatController, "W02FvT4MfSuip4pnzqS69K1WFM0=", false, function() {
    return [
...
"[project]/components/chatbot/roadmaps.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MermaidDiagram = ({ chart })=>{
    ...
    const [isError, setIsError] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Asumimos que está incompleto al inicio
    const uniqueId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useId"])().replace(/:/g, ''); // Crea un ID único seguro para React
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MermaidDiagram.useEffect": ()=>{
            let isMounted = true;
            // 2. DEBOUNCE: Esperamos 400ms sin que la IA escriba antes de procesar
            const timeoutId = setTimeout({
                "MermaidDiagram.useEffect.timeoutId": async ()=>{
                    if (!containerRef.current) return;
                    try {
                        const cleanChart = chart.replace(/,\s*$/gm, '').trim();
                        // Renderizamos usando nuestro ID único
                        const { svg } = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$mermaid$2e$core$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].render(`mermaid-${uniqueId}`, cleanChart);
            ...
            }["MermaidDiagram.useEffect.timeoutId"], 400); // 400 milisegundos de respiro para el navegador
            return ({
                "MermaidDiagram.useEffect": ()=>{
                    isMounted = false;
...
_s(MermaidDiagram, "yMDSEmNYhEU+yK5El6z7Szey3II=", false, function() {
    return [
...
"[project]/components/simulators/VectorVisualizer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_c = VectorVisualizer;
var _c;
__turbopack_context__.k.register(_c, "VectorVisualizer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/AtherVoice.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAtherVoice(onTranscript, voiceModeActive = false) {
    _s();
    const [voiceState, setVoiceState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        ttsEnabled: false,
        isSpeaking: false,
        isListening: false,
        transcript: '',
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAtherVoice.useEffect": ()=>{
            const tts = ("TURBOPACK compile-time value", "object") !== 'undefined' && 'speechSynthesis' in window;
            const stt = ("TURBOPACK compile-time value", "object") !== 'undefined' && ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window);
            setVoiceState({
                "useAtherVoice.useEffect": (s)=>({
                        ...s,
                        supported: {
                            tts,
                            stt
    ...
    const cleanupAudio = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAtherVoice.useCallback[cleanupAudio]": ()=>{
            if (audioRef.current) {
    ...
    const speak = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAtherVoice.useCallback[speak]": (text)=>{
            ...
            setVoiceState({
                "useAtherVoice.useCallback[speak]": (s)=>({
                        ...s,
                        isSpeaking: true
                    })
            }["useAtherVoice.useCallback[speak]"]);
            return fetch('/api/tts', {
                ...
                "useAtherVoice.useCallback[speak]": async (res)=>{
                    ...
                    return new Promise({
                        "useAtherVoice.useCallback[speak]": (resolve, reject)=>{
                            audio.onended = ({
                                "useAtherVoice.useCallback[speak]": ()=>resolve()
                            })["useAtherVoice.useCallback[speak]"];
                            audio.onerror = ({
                                "useAtherVoice.useCallback[speak]": ()=>reject(new Error('Error reproduciendo audio de ElevenLabs'))
                            })["useAtherVoice.useCallback[speak]"];
                            audio.play().catch(reject);
                        }
                    }["useAtherVoice.useCallback[speak]"]);
                }
            }["useAtherVoice.useCallback[speak]"]).catch({
                "useAtherVoice.useCallback[speak]": (err)=>{
            ...
            }["useAtherVoice.useCallback[speak]"]).finally({
                "useAtherVoice.useCallback[speak]": ()=>{
                    cleanupAudio();
                    setVoiceState({
                        "useAtherVoice.useCallback[speak]": (s)=>({
    ...
    const stopSpeaking = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAtherVoice.useCallback[stopSpeaking]": ()=>{
            abortRef.current?.abort();
            cleanupAudio();
            window.speechSynthesis?.cancel();
            setVoiceState({
                "useAtherVoice.useCallback[stopSpeaking]": (s)=>({
                        ...s,
                        isSpeaking: false
                    })
            }["useAtherVoice.useCallback[stopSpeaking]"]);
    ...
    const toggleTTS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAtherVoice.useCallback[toggleTTS]": ()=>{
            setVoiceState({
                "useAtherVoice.useCallback[toggleTTS]": (s)=>{
                    if (s.ttsEnabled) {
                        abortRef.current?.abort();
                        cleanupAudio();
                        window.speechSynthesis?.cancel();
    ...
    const startListening = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAtherVoice.useCallback[startListening]": ()=>{
            ...
            recognition.onstart = ({
                "useAtherVoice.useCallback[startListening]": ()=>setVoiceState({
                        "useAtherVoice.useCallback[startListening]": (s)=>({
                                ...s,
                                isListening: true,
                                transcript: ''
                            })
            ...
            recognition.onresult = ({
                "useAtherVoice.useCallback[startListening]": (e)=>{
                    let interim = '';
                    let final = '';
    ...
    const stopListening = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAtherVoice.useCallback[stopListening]": ()=>{
            recognitionRef.current?.stop();
            setVoiceState({
                "useAtherVoice.useCallback[stopListening]": (s)=>({
                        ...s,
                        isListening: false,
                        transcript: ''
                    })
...
_s(useAtherVoice, "QC//BvkJtKdZ8yGHlClTQBexo5Y=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/VoiceMode/VoiceMode.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useVoiceMode(onMessage) {
    ...
    const silenceTimer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const cleanupAudio = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[cleanupAudio]": ()=>{
            if (audioRef.current) {
                audioRef.current.pause();
                audioRef.current.onended = null;
                audioRef.current.onerror = null;
    ...
    const openVoiceMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[openVoiceMode]": ()=>{
            abortRef.current = false;
            setState({
                "useVoiceMode.useCallback[openVoiceMode]": (s)=>({
                        ...s,
                        active: true,
                        turn: 'idle',
                        error: null
    ...
    const closeVoiceMode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[closeVoiceMode]": ()=>{
            abortRef.current = true;
            window.speechSynthesis?.cancel();
            cleanupAudio();
            mediaRecorderRef.current?.stop();
            streamRef.current?.getTracks().forEach({
                "useVoiceMode.useCallback[closeVoiceMode]": (t)=>t.stop()
            }["useVoiceMode.useCallback[closeVoiceMode]"]);
            if (silenceTimer.current) clearTimeout(silenceTimer.current);
            setState({
                "useVoiceMode.useCallback[closeVoiceMode]": (s)=>({
                        ...s,
                        active: false,
                        turn: 'idle'
                    })
    ...
    const speak = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[speak]": (text, onEnd)=>{
            const clean = cleanForSpeech(text);
            if (!clean) {
                onEnd();
                return;
            ...
            window.speechSynthesis?.cancel();
            setState({
                "useVoiceMode.useCallback[speak]": (s)=>({
                        ...s,
                        turn: 'speaking'
                    })
            }["useVoiceMode.useCallback[speak]"]);
            fetch('/api/tts', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                ...
                "useVoiceMode.useCallback[speak]": async (res)=>{
                    if (!res.ok) throw new Error(`TTS respondió ${res.status}`);
                    const blob = await res.blob();
                    const url = URL.createObjectURL(blob);
                    audioUrlRef.current = url;
                    ...
                    audioRef.current = audio;
                    return new Promise({
                        "useVoiceMode.useCallback[speak]": (resolve, reject)=>{
                            audio.onended = ({
                                "useVoiceMode.useCallback[speak]": ()=>resolve()
                            })["useVoiceMode.useCallback[speak]"];
                            audio.onerror = ({
                                "useVoiceMode.useCallback[speak]": ()=>reject(new Error('Error reproduciendo audio de ElevenLabs'))
                            })["useVoiceMode.useCallback[speak]"];
                            audio.play().catch(reject);
                        }
                    }["useVoiceMode.useCallback[speak]"]);
                }
            }["useVoiceMode.useCallback[speak]"]).catch({
                "useVoiceMode.useCallback[speak]": (err)=>{
            ...
            }["useVoiceMode.useCallback[speak]"]).finally({
                "useVoiceMode.useCallback[speak]": ()=>{
                    cleanupAudio();
    ...
    const startRecording = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[startRecording]": async ()=>{
            if (abortRef.current) return;
            setState({
                "useVoiceMode.useCallback[startRecording]": (s)=>({
                        ...s,
                        turn: 'listening',
                        transcript: ''
                    })
            }["useVoiceMode.useCallback[startRecording]"]);
            try {
                ...
                recorder.ondataavailable = ({
                    "useVoiceMode.useCallback[startRecording]": (e)=>{
                ...
                recorder.onstop = ({
                    "useVoiceMode.useCallback[startRecording]": async ()=>{
                        stream.getTracks().forEach({
                            "useVoiceMode.useCallback[startRecording]": (t)=>t.stop()
                        }["useVoiceMode.useCallback[startRecording]"]);
                        if (abortRef.current) return;
                ...
                }["useVoiceMode.useCallback[startRecording]"], 8000);
            } catch  {
                setState({
                    "useVoiceMode.useCallback[startRecording]": (s)=>({
                            ...s,
    ...
    const transcribeAndRespond = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[transcribeAndRespond]": async (blob)=>{
            if (abortRef.current) return;
            setState({
                "useVoiceMode.useCallback[transcribeAndRespond]": (s)=>({
                        ...s,
                        turn: 'processing'
                    })
            }["useVoiceMode.useCallback[transcribeAndRespond]"]);
            try {
                // 1. Groq Whisper STT
    ...
    const interrupt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const startVoiceCycle = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useVoiceMode.useCallback[startVoiceCycle]": ()=>{
            abortRef.current = false;
            startRecording();
        }
    }["useVoiceMode.useCallback[startVoiceCycle]"], [
...
_s(useVoiceMode, "hoi4uc6RvmfcDmYzD+2eb4CqoqQ=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/VoiceMode/VoiceOverlay.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function VoiceOrb({ turn, onClick }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VoiceBlobField, {
                active: blobActive
            }, void 0, false, {
                fileName: "[project]/components/chatbot/VoiceMode/VoiceOverlay.tsx",
                lineNumber: 89,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                children: [
                    ...
                    turn === 'speaking' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        style: {
                            position: 'absolute',
                            bottom: 14,
                            display: 'flex',
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(VoiceOrb, {
                            turn: turn,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                turn === 'idle' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    style: {
                                        fontFamily: F_RAJ,
                                        fontSize: '0.65rem',
                                ...
                                turn === 'speaking' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    style: {
                                        fontFamily: F_RAJ,
                                        fontSize: '0.65rem',
                                        color: 'rgba(210,170,140,0.3)',
...
_c2 = VoiceModeOverlay;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "VoiceBlobField");
__turbopack_context__.k.register(_c1, "VoiceOrb");
__turbopack_context__.k.register(_c2, "VoiceModeOverlay");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/MessageAudioButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
_s(MessageAudioButton, "V8YbV+gTZxGliGj1g0fftBlvsq4=");
_c = MessageAudioButton;
var _c;
__turbopack_context__.k.register(_c, "MessageAudioButton");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/UIChatbot/academicResources.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AcademicSourceCard({ sources }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: sources.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                href: s.url,
                target: "_blank",
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            s.author && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    "· ",
                                    s.author
                                ]
                            ...
                            s.publishedDate && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                children: [
                                    "· ",
                                    s.publishedDate
                                ]
...
_c = AcademicSourceCard;
var _c;
__turbopack_context__.k.register(_c, "AcademicSourceCard");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/UIChatbot/interactiveCards.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: cards.map((_, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(InteractiveFlashcards, "1j6MzEvfD6XvZwKB2sjQXTNdulg=");
_c = InteractiveFlashcards;
var _c;
__turbopack_context__.k.register(_c, "InteractiveFlashcards");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/UIChatbot/comparation.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdvantageMark({ side, advantage }) {
    ...
    return wins ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AdvantageMark, {
                                                side: "A",
...
_c1 = ComparisonTable;
var _c, _c1;
__turbopack_context__.k.register(_c, "AdvantageMark");
__turbopack_context__.k.register(_c1, "ComparisonTable");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/chatbot/UIChatbot/timeline.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: events.map((e, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "relative",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_c = ConceptTimeline;
var _c;
__turbopack_context__.k.register(_c, "ConceptTimeline");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$controllers$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/controllers/AI/chatbot.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/models/AI/chatbot.ts [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$roadmaps$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/roadmaps.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$simulators$2f$VectorVisualizer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/simulators/VectorVisualizer.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$AtherVoice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/AtherVoice.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$VoiceMode$2f$VoiceMode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/VoiceMode/VoiceMode.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$VoiceMode$2f$VoiceOverlay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/VoiceMode/VoiceOverlay.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$MessageAudioButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/MessageAudioButton.tsx [app-client] (ecmascript)");
//UI Components
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$academicResources$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/UIChatbot/academicResources.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$interactiveCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/UIChatbot/interactiveCards.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$comparation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/UIChatbot/comparation.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$timeline$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/chatbot/UIChatbot/timeline.tsx [app-client] (ecmascript)");
;
...
// ── Icons ──────────────────────────────────────────────────────
const IconMenu = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
        width: "14",
        height: "14",
        viewBox: "0 0 24 24",
        fill: "none",
...
function AltMessageBubble({ msg, isLast, busy, onSpeakMessage, currentlySpeakingId }) {
    ...
    const markdownComponents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AltMessageBubble.useMemo[markdownComponents]": ()=>({
                code ({ node, inline, className, children, ...props }) {
                    const match = /language-(\w+)/.exec(className || '');
                    // Si el bloque es tipo "mermaid", dibuja el roadmap
                    if (!inline && match && match[1] === 'mermaid') {
                        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$roadmaps$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MermaidDiagram"], {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isAI && msg.text && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$MessageAudioButton$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                text: msg.text,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: showTyping ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TypingDots, {}, void 0, false, {
                            fileName: "[project]/app/chatbot/page.tsx",
                            lineNumber: 245,
                            columnNumber: 13
                                    ...
                                    switch(tool.toolName){
                                        case 'vectorSimulator':
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$simulators$2f$VectorVisualizer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["VectorVisualizer"], {
                                                    v1: tool.result.v1,
                                                    v2: tool.result.v2,
                                        ...
                                        case 'buscarFuentesAcademicas':
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$academicResources$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AcademicSourceCard"], {
                                        ...
                                        case 'generarFlashcards':
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$interactiveCards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["InteractiveFlashcards"], {
                                        ...
                                        case 'compararConceptos':
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$comparation$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComparisonTable"], {
                                        ...
                                        case 'generarLineaDeTiempo':
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$UIChatbot$2f$timeline$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConceptTimeline"], {
                                                topic: tool.result.topic,
...
_s(AltMessageBubble, "XvycEzqAKgg3QIu3CUySgc/Rvl8=");
_c4 = AltMessageBubble;
...
function NeuralField3D() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NeuralField3D.useEffect": ()=>{
            ...
            const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](55, container.clientWidth / container.clientHeight, 0.1, 200);
            ...
            const particleGeo = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferGeometry"]();
            particleGeo.setAttribute('position', new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferAttribute"](positions, 3));
            particleGeo.setAttribute('color', new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["BufferAttribute"](colors, 3));
            const particleMat = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PointsMaterial"]({
                size: 0.12,
                vertexColors: true,
                transparent: true,
                opacity: 0.85,
            ...
            const particles = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Points"](particleGeo, particleMat);
            scene.add(particles);
...
_s1(NeuralField3D, "V9/qkEdV8GfsDZk7lMTA1T8g5Ps=");
_c5 = NeuralField3D;
// ── Hex grid SVG ───────────────────────────────────────────────
...
function AltChatView() {
    _s2();
    const { state, messagesEndRef, toggleSidebar, loadSession, newChat, setInput, sendMessage, handleKeyDown, handleSubmit } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$controllers$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAltChatController"])();
    //Voice
    const { state: voiceModeState, openVoiceMode, closeVoiceMode, startVoiceCycle, interrupt } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$VoiceMode$2f$VoiceMode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVoiceMode"])({
        "AltChatView.useVoiceMode": (role, text)=>{
            if (role === 'user') {
                sendMessage(text);
    ...
    }["AltChatView.useVoiceMode"]);
    const { voiceState, speak, stopSpeaking, toggleTTS, startListening, stopListening } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$AtherVoice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAtherVoice"])({
        "AltChatView.useAtherVoice": (transcript)=>{
            sendMessage(transcript);
        }
    }["AltChatView.useAtherVoice"], voiceModeState.active);
    const { sidebarOpen, sessions, currentSession, messages, input, busy } = state;
    const [currentlySpeakingId, setCurrentlySpeakingId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const containerRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    // ── Entrance animations ──
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AltChatView.useEffect": ()=>{
            const root = containerRef.current;
            if (!root) return;
            const prefersReduced = window.matchMedia('(prefers-reduced-motion: reduce)').matches;
            let split = null;
            const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].context({
                "AltChatView.useEffect.ctx": ()=>{
                    // Header title SplitText
                    if (titleRef.current && !prefersReduced) {
                        split = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$SplitText$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SplitText"](titleRef.current, {
                            type: 'chars'
                        });
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to('.alt-status-dot', {
                        scale: 1.25,
                    ...
                    if (!prefersReduced) {
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to('.alt-empty-ring', {
                            scale: 1.08,
                            opacity: 0.7,
                            yoyo: true,
                            repeat: -1,
            ...
            }["AltChatView.useEffect.ctx"], root);
            return ({
                "AltChatView.useEffect": ()=>{
                    split?.revert();
                    ctx.revert();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AltChatView.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].fromTo(btns, {
                opacity: 0,
                y: 20,
                scale: 0.9
            }, {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].to(btns, {
                y: -3,
                duration: 2.2,
                yoyo: true,
                repeat: -1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AltChatView.useEffect": ()=>{
            ...
            const updateProgress = {
                "AltChatView.useEffect.updateProgress": ()=>{
            ...
            if (messages.length > 0 && !prefersReduced) {
                ...
                if (last && last.classList && last.classList.contains('alt-bubble')) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["gsap"].fromTo(last, {
                        opacity: 0,
                        y: 18,
                        scale: 0.97
                    }, {
            ...
            return ({
                "AltChatView.useEffect": ()=>root.removeEventListener('scroll', updateProgress)
            })["AltChatView.useEffect"];
        }
    }["AltChatView.useEffect"], [
        messages
    ]);
    const handleSpeakMessage = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AltChatView.useCallback[handleSpeakMessage]": (text, id)=>{
            if (text) {
                ...
                if (result && typeof result.then === 'function') {
                    result.then({
                        "AltChatView.useCallback[handleSpeakMessage]": ()=>setCurrentlySpeakingId(null)
                    }["AltChatView.useCallback[handleSpeakMessage]"]).catch({
                        "AltChatView.useCallback[handleSpeakMessage]": ()=>setCurrentlySpeakingId(null)
                    }["AltChatView.useCallback[handleSpeakMessage]"]);
                }
            } else {
                stopSpeaking();
    ...
    const handleHoverBtn = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AltChatView.useCallback[handleHoverBtn]": (e, enter)=>{
    ...
    }["AltChatView.useCallback[handleHoverBtn]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AltChatView.useEffect": ()=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
      ...
      `
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: sessions.map((s)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(IconMenu, {}, void 0, false, {
                                            fileName: "[project]/app/chatbot/page.tsx",
                                            lineNumber: 796,
                                            columnNumber: 15
                                        }, this)
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    messages.length === 0 ? /* Empty state */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                            flex: 1,
                                            display: 'flex',
                                            flexDirection: 'column',
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ALT_QUICK_PROMPTS"].map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: [
                                            messages.map((msg, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(AltMessageBubble, {
                                                    msg: {
                                                        ...msg,
                                                        id: String(i)
                                                    },
                                            ...
                                            busy && messages[messages.length - 1]?.role === 'user' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                style: {
                                                    display: 'flex',
                                                    gap: 9,
                                                    alignItems: 'flex-start'
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                    ...
                                                    children: voiceModeState.active ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("path", {
                                                        strokeLinecap: "round",
                                                        strokeLinejoin: "round",
                                                        d: "M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.348a1.125 1.125 0 0 1 0 1.971l-11.54 6.347a1.125 1.125 0 0 1-1.667-.985V5.653Z"
                                                    }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$VoiceMode$2f$VoiceOverlay$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s2(AltChatView, "ZvpzY53Q988ue51XbQHWOxCBQGE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$controllers$2f$AI$2f$chatbot$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAltChatController"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$VoiceMode$2f$VoiceMode$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useVoiceMode"],
        __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$chatbot$2f$AtherVoice$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAtherVoice"]
    ];
});
_c7 = AltChatView;
var _c, _c1, _c2, _c3, _c4, _c5, _c6, _c7;
__turbopack_context__.k.register(_c, "IconMenu");
__turbopack_context__.k.register(_c1, "IconPlus");
__turbopack_context__.k.register(_c2, "IconSend");
__turbopack_context__.k.register(_c3, "TypingDots");
__turbopack_context__.k.register(_c4, "AltMessageBubble");
__turbopack_context__.k.register(_c5, "NeuralField3D");
__turbopack_context__.k.register(_c6, "HexBackground");
__turbopack_context__.k.register(_c7, "AltChatView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0wtiqul._.js.map