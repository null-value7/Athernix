...
export default function LoginView() {
  ...
  return (
    ...
    >
      ...
      <ParallaxLayer speed={0.2} direction="up" className="absolute inset-0 pointer-events-none">
        <div
          className="orb-1 absolute rounded-full float-gentle"
          style={{
            width: 500,
            height: 500,
            top: "-10%",
      ...
      <ParallaxLayer speed={0.3} direction="down" className="absolute inset-0 pointer-events-none">
        <div
          className="orb-2 absolute rounded-full float-medium"
          style={{
            width: 400,
            height: 400,
            bottom: "-5%",
      ...
      {/* Card */}
      <ScrollReveal effect="scaleIn" duration={0.9}>
      <div
        ref={cardRef}
        onMouseMove={(e) => {
          ...
          gsap.to(cardRef.current, { rotateY: x, rotateX: y, duration: 0.5, ease: "power2.out", transformPerspective: 1000 });
        }}
        onMouseLeave={() => {
          if (!cardRef.current) return;
          gsap.to(cardRef.current, { rotateY: 0, rotateX: 0, duration: 0.5, ease: "power2.out" });
        }}
        className="relative w-full max-w-sm mx-4 rounded-2xl px-8 py-10 gradient-border card-3d liquid-glass"
        style={{
          ...
          <div className="form-field">
            ...
            >
              <input
                ...
                onFocus={(e) => {
                  handleInputFocus(e);
                  e.currentTarget.parentElement?.classList.add("glow-orange");
                }}
                onBlur={(e) => {
                  handleInputBlur(e);
                  e.currentTarget.parentElement?.classList.remove("glow-orange");
                }}
