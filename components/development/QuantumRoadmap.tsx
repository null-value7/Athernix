...
import {
  Calculator, Settings, Atom, Activity, Triangle,
  RotateCw, Square, ArrowRight, Waves, CircleDot,
  Infinity as InfinityIcon, Cpu, Lock, Check, Play,
  type LucideIcon,
} from 'lucide-react';
import {
  QuantumNode,
            ...
            >
              ...
              >
                ...
                <div className="flex items-center justify-between mb-1">
                  ...
                  >
                    {isLocked ? <Lock size={11} /> : <NodeIcon icon={node.icon} size={11} />}
                  </div>
                  <span
                    style={{
                      fontFamily: F_MONO,
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-4">
          ...
          >
            <NodeIcon icon={statusCfg.icon} size={10} />
            <span
              style={{
                fontFamily: F_MONO,
                fontSize: 8,
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          >
            {node.status === 'locked' ? <Lock size={22} /> : <NodeIcon icon={node.icon} size={22} />}
          </div>
          <div>
            <h3
              style={{
