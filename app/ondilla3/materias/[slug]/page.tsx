    ...
    <div>
      <section className="relative h-[85vh] w-full overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 flex flex-col items-start bg-gradient-to-t from-background via-background/60 to-transparent px-6 pb-10 pt-24 sm:px-10">
          ...
          <h1 className="font-display mt-2 text-5xl text-white sm:text-7xl">{protectBrands(materia.nombre)}</h1>
          <p className="mt-1 text-sm italic text-white/60 sm:text-base">{protectBrands(materia.tagline)}</p>
        </div>
        ...
        {/* Señal de scroll — esquina inferior derecha, espejo del pill superior */}
        <div className="pointer-events-none absolute bottom-6 right-6 flex flex-col items-center gap-2 text-white/40 sm:right-10">
          <span className="font-mono-label text-[9px]">DESLIZA</span>
      ...
      <section className="relative mx-auto max-w-4xl px-6 py-16 sm:px-10">
        ...
        <p className="mt-8 max-w-2xl text-lg leading-relaxed text-white/75">{protectBrands(materia.descripcion)}</p>
