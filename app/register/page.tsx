...
export default function RegisterView() {
  ...
  return (
    ...
    >
      ...
      {/* ── Glow de fondo ─────────────────────────────────── */}
      <ParallaxLayer speed={0.15} direction="up" className="absolute inset-0 pointer-events-none">
        <div
          ref={glowRef}
          className="absolute inset-0 pointer-events-none float-gentle"
          style={{
      ...
      <div
        ...
        className="relative w-full max-w-sm mx-4 rounded-2xl overflow-hidden gradient-border card-3d liquid-glass"
        style={{
