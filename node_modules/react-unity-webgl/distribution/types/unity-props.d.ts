...
type UnityProps = Pick<UnityArguments, "devicePixelRatio" | "matchWebGLToCanvasSize" | "disabledCanvasEvents"> & Pick<HTMLCanvasElementProps, "id" | "style" | "className" | "tabIndex"> & {
    /**
