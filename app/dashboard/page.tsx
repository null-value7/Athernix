...
function StatCard({ label, value, sub, color, icon }: {
  ...
  return (
    <div ref={ref} className="stat-card glass-card rise-in relative overflow-hidden cursor-default px-5 py-4"
...
function RoleDonut({ byRole }: { byRole: AdminStats['by_role'] }) {
  ...
  let offset = 0
  return (
    <div className="glass-card rise-in p-5 flex gap-5 items-center" style={{ minWidth: 200 }}>
...
function GlassesChart({ byGlasses, unset }: { byGlasses: AdminStats['by_glasses']; unset: number }) {
  ...
  if (total === 0) return (
    <div className="glass-card rise-in p-6 text-center" style={{ fontFamily: F.body, color: C.dimmer, fontSize: '0.75rem' }}>
...
function HealthScore({ stats }: { stats: AdminStats }) {
  ...
  return (
    <div className="glass-card rise-in p-5 flex items-center gap-5">
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center"
      ...
      <div className="glass-card p-7" style={{ width: 360, border: '1px solid rgba(255,0,110,0.24)', boxShadow: '0 0 50px rgba(255,0,110,0.14)' }}>
        ...
        <div className="flex gap-2.5">
          ...
          <button onClick={onSave} className="btn-launch flex-1">GUARDAR</button>
        </div>
      </div>
    </div>
  )
...
export default function AdminDashboardView() {
  ...
  return (
    <div className="adm-root">
      ...
      <AmbientParticles/>
      <div ref={scanRef} className="scanline-flash"/>
      ...
      <div className="relative z-10 flex min-h-screen overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0 relative">
          ...
          <div className="flex items-center gap-3 px-5 py-3 shrink-0"
            ...
            <div className="flex-1">
              <div style={{ fontFamily: F.display, fontSize: '1.05rem', color: C.text, letterSpacing: '.08em' }}>{sectionTitle[section]}</div>
