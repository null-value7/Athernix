...
type EventSystem = {
     ...
     */
    readonly addEventListener: (eventName: string, callback: (...parameters: UnityEventParameter[]) => UnityEventParameter) => void;
    /**
     * Removes an event listener for external React Unity events.
     * @param eventName The name of the event to remove.
     * @param callback The callback to remove.
     */
    readonly removeEventListener: (eventName: string, callback: (...parameters: UnityEventParameter[]) => UnityEventParameter) => void;
};
