  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-black/40">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-10 px-6 py-14 md:flex-row md:justify-between">
        <div>
          <span className="font-display text-gradient-fire text-2xl tracking-[0.1em]"><span className="notranslate" translate="no">ATHERNIX</span></span>
        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-2">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-sm text-white/60">
              <li>
                <Link href="/ondilla3" className="inline-block transition-all hover:translate-x-1 hover:text-white">Inicio</Link>
              </li>
              <li>
                <Link href="/ondilla3/materias" className="inline-block transition-all hover:translate-x-1 hover:text-white">Todas las materias</Link>
              </li>
            </ul>
          </div>
        </div>
