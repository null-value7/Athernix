...
import { Button } from "@/components/ui/OndillaButton";
    ...
    >
      ...
      >
        ...
        <Magnetic strength={0.25}>
          <Link href="/ondilla3/materias" data-cursor-hover>
  ...
  return (
    ...
    >
      <div className="fire-border relative overflow-hidden rounded-3xl bg-black/35 p-6 backdrop-blur-md sm:p-8">
        ...
        >
          {protectBrands(materia.nombre)}
        </motion.h2>
        <p className="mt-1 text-sm italic text-white/50">{protectBrands(materia.tagline)}</p>
        <p className="relative mt-4 max-w-md text-sm leading-relaxed text-white/70">{protectBrands(materia.descripcion)}</p>
        ...
        <div className="pointer-events-auto relative mt-6">
          <Magnetic>
            <Link href={`/ondilla3/materias/${materia.slug}`} data-cursor-hover>
              <Button size="sm">
