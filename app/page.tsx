...
// ════════════════════════════════════════════════════════════
// CABECERA UNIVERSAL — bloque reusable para cualquier
// migración JSX → TSX que use window.* de librerías CDN
// (Three.js, GSAP, ScrollTrigger) + DOM manipulado a mano.
// ════════════════════════════════════════════════════════════
...
// Tipos para las partículas usadas en los distintos canvas 2D
  ...
  useEffect(() => {
    ...
    const init = () => {
      ...
      try {
        ...
        const introBtn    = document.getElementById('intro-btn')    as HTMLButtonElement | null;
        const impactFlash = document.getElementById('impact-flash') as HTMLElement | null;
            ...
            onComplete: () => {
              ...
              setInterval(() => {
                ...
                if (t) {
                  ...
                  setTimeout(() => t.classList.remove('glitch-active'), 150);
                }
              }, 4000);
            },
          });
        ...
        const tMat = new window.THREE.PointsMaterial({
          ...
          blending: window.THREE.AdditiveBlending, sizeAttenuation: true,
        });
        ...
        // ════════════════════════════════════════════
        interface StatDatum { el: string; target: number; suffix: string; decimals: number }
        const statData: StatDatum[] = [
        ...
        if (nodeCanvas) {
          const ctx = nodeCanvas.getContext('2d') as CanvasRenderingContext2D | null;
          if (ctx) {
            const resize = () => {
        ...
        <section className="info-section" id="sec-stats">
          <div className="info-container">
            ...
            <div className="stats-grid">
              <div className="stat-card glass-card anim-reveal-up" style={{ '--delay': '0s' } as React.CSSProperties}>
              ...
              <div className="stat-card glass-card anim-reveal-up" style={{ '--delay': '0.15s' } as React.CSSProperties}>
              ...
              <div className="stat-card glass-card anim-reveal-up" style={{ '--delay': '0.3s' } as React.CSSProperties}>
              ...
              <div className="stat-card glass-card anim-reveal-up" style={{ '--delay': '0.45s' } as React.CSSProperties}>
        ...
        <section className="info-section" id="sec-features">
          <div className="info-container">
            ...
            <div className="features-grid">
              <div className="feature-card glass-card anim-reveal-up" style={{ '--delay': '0s' } as React.CSSProperties}>
              ...
              <div className="feature-card glass-card anim-reveal-up" style={{ '--delay': '0.12s' } as React.CSSProperties}>
              ...
              <div className="feature-card glass-card anim-reveal-up" style={{ '--delay': '0.24s' } as React.CSSProperties}>
                <div className="feature-icon">⚡</div>
                <h3>Computo en el Borde</h3>
                <p>Procesa datos en el borde con latencia sub-milisegundo en todas las 47 regiones.</p>
                <div className="feature-line"></div>
              </div>
              <div className="feature-card glass-card anim-reveal-up" style={{ '--delay': '0.36s' } as React.CSSProperties}>
                <div className="feature-icon">👁️</div>
                <h3>Nodos Fantasma</h3>
                <p>Puntos finales señuelo redirigen el tráfico adversario a vacíos honeypot automáticamente.</p>
                <div className="feature-line"></div>
              </div>
              <div className="feature-card glass-card anim-reveal-up" style={{ '--delay': '0.48s' } as React.CSSProperties}>
                <div className="feature-icon">🔗</div>
                <h3>Autenticación de Conocimiento Cero</h3>
                <p>Verifica identidad sin exponer credenciales. Prueba matemática, no confianza.</p>
                <div className="feature-line"></div>
              </div>
              <div className="feature-card glass-card anim-reveal-up" style={{ '--delay': '0.6s' } as React.CSSProperties}>
                <div className="feature-icon">🕐</div>
