...
function AltMessageBubble({
  ...
  return (
    <ScrollReveal effect="fadeUp" duration={0.4}>
    <div style={{
      display:       'flex',
      gap:           9,
    ...
    <>
      ...
      <div style={{
        ...
        {(['tl','tr','bl','br'] as const).map(pos => (
          <div key={pos} className="float-gentle" style={{
        ...
        {/* ── Sidebar ── */}
        <div className="liquid-glass glass-card-interactive" style={{
