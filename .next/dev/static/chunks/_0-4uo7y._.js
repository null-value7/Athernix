...
"[project]/components/home/BrainMap3DFbx.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrainMap3DFbx({ achievements }) {
    ...
    const brainGroupRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const brainPartsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    const fbxLoadedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    const achievementsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(achievements);
    ...
    const updateColors = ()=>{
        ...
        achievementsRef.current.forEach((achievement, i)=>{
            ...
            if (achievement.unlocked) {
                const c = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Color"](achievement.color);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrainMap3DFbx.useEffect": ()=>{
            if (!containerRef.current) return;
            const container = containerRef.current;
            // Scene setup
            const scene = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Scene"]();
            sceneRef.current = scene;
            const camera = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PerspectiveCamera"](52, container.clientWidth / container.clientHeight, 0.1, 1000);
            ...
            let mx = 0, my = 0;
            const onMouseMove = {
                "BrainMap3DFbx.useEffect.onMouseMove": (e)=>{
                    const rect = container.getBoundingClientRect();
                    mx = ((e.clientX - rect.left) / rect.width - 0.5) * 2;
                    my = -((e.clientY - rect.top) / rect.height - 0.5) * 2;
                }
            }["BrainMap3DFbx.useEffect.onMouseMove"];
            ...
            scene.add(particles);
            // Load FBX brain
            const loader = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$examples$2f$jsm$2f$loaders$2f$FBXLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FBXLoader"]();
            loader.load('/models/cerebro.fbx', {
                "BrainMap3DFbx.useEffect": (fbx)=>{
                    // Collect all meshes
                    const parts = [];
                    fbx.traverse({
                        "BrainMap3DFbx.useEffect": (child)=>{
                    ...
                    console.log('[BrainMap3D FBX meshes]', parts.map({
                        "BrainMap3DFbx.useEffect": (p)=>p.name
                    }["BrainMap3DFbx.useEffect"]));
                    // Center and scale to fit
                    const box = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Box3"]().setFromObject(fbx);
                    ...
                    const center = box.getCenter(new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Vector3"]()).multiplyScalar(-scale);
            ...
            }["BrainMap3DFbx.useEffect"], undefined, {
                "BrainMap3DFbx.useEffect": (err)=>{
            ...
            let animationId;
            const animate = {
                "BrainMap3DFbx.useEffect.animate": ()=>{
                    animationId = requestAnimationFrame(animate);
                    const t = Date.now() * 0.001;
                    const brainGroup = brainGroupRef.current;
                    if (brainGroup) {
                        brainGroup.rotation.y = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].lerp(brainGroup.rotation.y, t * 0.35 + mx * 0.5, 0.06);
                        brainGroup.rotation.x = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$three$2f$build$2f$three$2e$core$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MathUtils"].lerp(brainGroup.rotation.x, my * 0.3, 0.06);
                    }
            ...
            // Resize
            const handleResize = {
                "BrainMap3DFbx.useEffect.handleResize": ()=>{
            ...
            return ({
                "BrainMap3DFbx.useEffect": ()=>{
                    ...
                    scene.clear();
                    brainGroup.traverse({
                        "BrainMap3DFbx.useEffect": (obj)=>{
                            const mesh = obj;
                            if (mesh.geometry) mesh.geometry.dispose();
                            if (mesh.material) {
                                if (Array.isArray(mesh.material)) mesh.material.forEach({
                                    "BrainMap3DFbx.useEffect": (m)=>m.dispose()
                                }["BrainMap3DFbx.useEffect"]);
...
_s(BrainMap3DFbx, "rLCq3CavRYaUqL9v0qzhU34es4w=");
_c = BrainMap3DFbx;
var _c;
__turbopack_context__.k.register(_c, "BrainMap3DFbx");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$home$2f$BrainMap3DFbx$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/home/BrainMap3DFbx.tsx [app-client] (ecmascript)");
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$home$2f$BrainMap3DFbx$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
//# sourceMappingURL=_0-4uo7y._.js.map