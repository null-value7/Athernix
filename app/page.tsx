          ...
          <div className="info-visual">
            <div className="term">
              <div className="t-bar">
                ...
                <span className="mono" style={{"marginLeft":"auto","fontSize":"9px","color":"rgba(255,255,255,0.3)"}}>raíz@<span className="notranslate" translate="no">athernix</span>:~</span>
              </div>
    ...
    <section className="info-section" id="sec-vision">
      <div className="info-container">
        <div className="about-vision glass-card anim-reveal">
          <blockquote>"El conocimiento es un viaje — y <span className="notranslate" translate="no">Athernix</span> es el vehículo. Aprender no debería estar limitado por cuatro paredes."</blockquote>
