  ...
  return (
    ...
    >
      ...
      <ParallaxLayer speed={0.15} className="absolute inset-0 pointer-events-none z-0">
        <div className="orb-p1 absolute rounded-full float-medium"
          style={{ width: 480, height: 480, top: '-8%', right: '-12%',
            background: 'radial-gradient(circle,rgba(180,30,30,0.22) 0%,transparent 70%)',
            filter: 'blur(45px)' }} />
      </ParallaxLayer>
      <ParallaxLayer speed={-0.1} className="absolute inset-0 pointer-events-none z-0">
        <div className="orb-p2 absolute rounded-full float-gentle"
      ...
      {/* Main card */}
      <ScrollReveal effect="scaleIn" delay={0.2} duration={0.8} className="relative z-10 w-full max-w-sm mx-4">
        <div ref={cardRef} className="relative w-full rounded-2xl px-8 py-10 liquid-glass card-3d" style={CARD_STYLE}>
        ...
        <div ref={avatarRef} className="flex flex-col items-center mb-6">
          ...
          <h2 className="p-info-block mt-4 text-xl font-black tracking-wide text-center"
            style={{ fontFamily: "'Orbitron', sans-serif",
              ...
              WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
            <TextSplitter text={fullName} effect="wave" />
          </h2>
        ...
        {/* Action buttons */}
        <ScrollReveal effect="fadeUp" stagger={0.1} delay={0.5} className="space-y-3">
          {/* Edit profile */}
          <MagneticElement>
      ...
      {state.editOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4"
          ...
          <div className="modal-card w-full max-w-sm rounded-2xl px-7 py-8 liquid-glass" style={CARD_STYLE}>
