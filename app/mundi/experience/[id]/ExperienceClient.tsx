...
const UnityExperience = lazy(() => import('../../components/UnityExperience'));
...
export default function ExperienceClient() {
  ...
  if (entered) {
    return (
      <Suspense fallback={<div className="exp-screen"><div className="exp-content"><p className="exp-status mono">CARGANDO_ENTORNO_VR...</p></div></div>}>
        <UnityExperience location={location} onBack={() => router.push('/mundi')} />
      </Suspense>
    );
  }
