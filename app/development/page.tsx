...
function StatCardItem({ card, index }: { card: StatCard; index: number }) {
  ...
  return (
    <div ref={ref} className="stat-card liquid-glass glass-card-interactive card-3d hover:glow-orange flex flex-col items-center gap-1.5 p-5 rounded-2xl border transition-all duration-300 cursor-default"
...
function STEMAreaCard({
  ...
  return (
    <div ref={cardRef}
      className="stem-card liquid-glass glass-card-interactive card-3d hover:glow-pink rounded-2xl overflow-hidden border transition-all duration-300"
      style={{
...
function RoadmapCardItem({ card, onSendToChat }: { card: RoadmapCard; onSendToChat: (p: string) => void }) {
  const ref = useRef<HTMLDivElement>(null)
  return (
    <div ref={ref} className="roadmap-card liquid-glass glass-card-interactive card-3d hover:glow-gold rounded-2xl p-5 border transition-all duration-300 cursor-pointer"
      style={{ background: 'rgba(18,8,22,0.88)', borderColor: 'rgba(180,60,40,0.18)' }}
      onMouseEnter={e => {
        gsap.to(ref.current, { y: -4, duration: 0.2, ease: 'power2.out' })
        const el = e.currentTarget
...
function NewsCard({ item }: { item: NewsItem }) {
  return (
    <a href={item.url} target="_blank" rel="noopener noreferrer"
      className="group block liquid-glass glass-card-interactive card-3d hover:glow-cyan rounded-2xl p-4 border transition-all duration-200"
    ...
    <>
      ...
      <div className="relative min-h-screen overflow-x-hidden"
        ...
        <ParallaxLayer speed={0.4} direction="up">
          <div className="orb-zd1 fixed pointer-events-none rounded-full float-medium"
        ...
        <ParallaxLayer speed={0.5} direction="down">
          <div className="orb-zd2 fixed pointer-events-none rounded-full float-gentle"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
          ...
          <div ref={heroRef} className="text-center mb-14">
            ...
            <h1 className="hero-title font-black leading-none mb-4"
              ...
              <TextSplitter text="ZONA DE DESARROLLO" splitBy="word" effect="flip" gradient={true} />
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-14">
            ...
            <div>
              ...
              <ScrollReveal effect="slideRight" stagger={0.1}>
              <div className="flex flex-col gap-3">
                {roadmaps.map(card => (
